...
const buttonScanear = document.getElementById('btn-texto');
const resultado = document.getElementById('saida');
const canvas = document.getElementById('canvas');

//METODO HABILITAR CAMERA
...
botaoScanear.onclick = async () => {
    ...
    //preparar cenario em 2d do canvas
    ...
    contexto.sectTransform(1, 0, 0, 1, 0, 0);
    ...
    try{
        ...
        resultado.innerText = textoFinal.length > 0 ? textoFinal : "Não foi possível capturar o texto";
    } catch (erro) {
